...
export default function CoordinatorWaitingListComponent() {
                ...
                >
                    <div id="24h">
                        <h1 class="font-bold text-black text-3xl py-4 uppercase">
                            Coordinator Actions - Waiting Students List
                            <br />
                        ...
                        <div id="" class="">
                            <div class="p-6 border border-black rounded-lg">
                                <div className="text-black text-xl pb-4">
                                    Current Waiting Students List
                                </div>
                                <div className="border border-black">
                                    <embed
                                        src={require("../../assets/2019-2020Erasmus+.pdf#page=1&zoom=500")}
                                        className="w-full"
                                        height="500"
                                    />
                                </div>
