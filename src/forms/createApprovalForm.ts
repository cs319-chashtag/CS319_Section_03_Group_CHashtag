// import { HeadingLevel, Packer, Paragraph, Table, TableCell, TableRow, VerticalAlign, TextDirection, TextRun, AlignmentType, WidthType } from "docx";
...
const doc = new docxReader.Document({
    ...
    sections: [
        {   
            ...
            children: [
                new Paragraph({
                    text : "Bilkent University Course Exemption Pre-Approval Form for Outgoing Exchange Students",
                            ...
                            children: [
                                new TableCell({
                                    ...
                                    children: [new Paragraph({
                                        ...
                                        children: [
                                            new TextRun({
                                                text: "Host institution courses to be transferred upon approval",
                                                bold: true,
                                            }),
                                        ],
                                    })],
...
Packer.toBuffer(doc).then((buffer) => {
    fs.writeFileSync("pre_approval_form_"+ studentData.id + ".docx", buffer);
});